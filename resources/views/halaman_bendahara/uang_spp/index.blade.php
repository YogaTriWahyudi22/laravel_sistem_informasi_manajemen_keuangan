                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>Data Pembayaran Uang SPP</h4>
                            </div>
                                        ...
                                        <tr class="text center">
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    ...
                                                    <a href="{{ route('detail', $i->id_siswa) }}"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        @endphp
                        <form action="{{ route('bayar_spp') }}" method="POST">
                            @csrf
                            <select class="form-control" name="bulan" aria-label="Default select example" required>
