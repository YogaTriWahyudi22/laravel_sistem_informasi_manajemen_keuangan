...
@section('content')
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>Data Pembayaran Uang Ujian</h4>
                            </div>
                ...
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                    <div class="pd-20">
                        <form action="{{ route('uang_ujian_cari') }}" method="POST">
                            @csrf
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    ...
                                                    <a href="" class="btn btn-success" class="btn btn-primary" id="pilih"
                                                        ...
                                                        data-target="#kelassaya{{ $i->id_siswa }}"><span
                                                            class="text-capitalize">bayar</span></a>

                                                    <a href="{{ route('uang_ujian_detail', $i->id_siswa) }}"
    ...
    @foreach ($siswa as $k)
        ...
        <!-- Modal -->
        <div class="modal fade" id="kelassaya{{ $k->id_siswa }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"><span class="text-capitalize">Form Pembayaran Uang
                                Ujian</span>
                        </h5>
                    ...
                    <div class="modal-body">
                        @php
                            ...
                            $b = ['Ganjil', 'Genap'];
                        @endphp
                        <form action="{{ route('bayar_uang_ujian') }}" method="POST">
                            @csrf
