        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    <form action="{{ route('guru_tambah', $edit->id_guru) }}" method="POST">
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Nama Guru</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" name="nama_guru" value="{{ $edit->nama_guru }}"
                                    placeholder="Input Nama Guru" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" name="bidang" value="{{ $edit->bidang }}"
                                    placeholder="Input Bidang" required>
                            </div>
                        </div>
